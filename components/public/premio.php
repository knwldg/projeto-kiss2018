<div id="premio1" class="desafio-premios-colecoes flex-column shadow">
    ...
    <div class="premios-title flex-row">
        ...
        <span id="titulo-premio1" class="premios-title-size font800 orange">ALMOÇO<span id="premios-subtitle" class="premios-subtitle font600 gray">(5/5)</span></span><!-- quantidade de cartas desbloqueadas -->
    ...
    <div class="colection flex-row">
        <!-- array das cartas -->
        <img class="carta-size" src="../img/cartas/equipa/thumbnail/frente/equipa1.png">
        <img class="carta-size" src="../img/cartas/equipa/thumbnail/frente/equipa2.png">
        <img class="carta-size" src="../img/cartas/equipa/thumbnail/frente/equipa3.png">
        <img class="carta-size" src="../img/cartas/equipa/thumbnail/frente/equipa4.png">
        <img class="carta-size" src="../img/cartas/equipa/thumbnail/frente/equipa5.png">
...
<div id="premio" class="desafio-premios-colecoes flex-column shadow">
